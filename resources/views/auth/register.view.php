...
?>   
     ...
     <div class="flex flex-col justify-between mt-20">
          ...
          <form action="<?= main_url() ?>/register" method="POST" class="w-80 mx-auto flex flex-col justify-between gap-3">
               ...
               <div>
                    <button type="submit" class="group w-full py-2 px-4 border border-transparent text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                         Register
                    </button>
               </div>
